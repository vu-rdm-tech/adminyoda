...
class ResearchFolder(models.Model):
    ...
    sram_open_invitations = models.IntegerField(default=0)
    sram_memberships = models.IntegerField(default=0)
    sram_co_id = models.CharField(max_length=255, blank=True, null=True)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
